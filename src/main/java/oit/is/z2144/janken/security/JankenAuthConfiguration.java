package oit.is.z2144.janken.security;
...
public class JankenAuthConfiguration {
  ...
  public InMemoryUserDetailsManager userDetailsService() {
    ...
    UserDetails user1 = User.withUsername("user1")
        .password("{bcrypt}$2y$10$Yr08VICPpv8wkRWlGTXVhOj4Ey8oJRCO80n9g2rdU.1.KYF8YCWqG").roles("USER").build();
    ...
    UserDetails honda = User.withUsername("ほんだ")
        .password("{bcrypt}$2y$10$xJNXFycm/hHy7RCxje1EW.SQQ9h.zPiVUr5a/GVH.LWJQ87i3fQKW").roles("USER").build();
